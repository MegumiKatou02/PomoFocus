<template>
  <div class="app">
    ...
    <div class="content">
      ...
      <footer class="footer">
        <p class="credits">
          Inspired by <a href="https://pomofocus.io/" target="_blank" rel="noopener">pomofocus.io</a>
        </p>
        <p class="github-link">
          <a href="https://github.com/MegumiKatou02/PomoFocus.git" target="_blank" rel="noopener">
